...
class Wave extends View {
    ...
    public final int DEFAULT_BLOW_WAVE_ALPHA = 160;
    ...
    private int mAboveWaveFromColor;
    private int mAboveWaveToColor;
    ...
    public void setAboveWaveColor(int aboveWaveFromColor, int aboveWaveToColor) {
        this.mAboveWaveFromColor = aboveWaveFromColor;
        this.mAboveWaveToColor = aboveWaveToColor;
    }
    ...
    public void initializePainters() {
        mAboveWavePaint.setShader(new LinearGradient(0, 0, WidgetUtils.getDm(getContext()).widthPixels, 0, mAboveWaveFromColor, mAboveWaveToColor, Shader.TileMode.MIRROR));
        mAboveWavePaint.setAlpha(DEFAULT_ABOVE_WAVE_ALPHA);
        mAboveWavePaint.setStyle(Paint.Style.FILL);
        mAboveWavePaint.setAntiAlias(true);

        mBlowWavePaint.setShader(new LinearGradient(0, 0, WidgetUtils.getDm(getContext()).widthPixels, 0, mAboveWaveFromColor, mAboveWaveToColor, Shader.TileMode.MIRROR));
    ...
    protected void onWindowVisibilityChanged(int visibility) {
        ...
        if (View.GONE == visibility) {
            ...
            if (BaseApplication.getInstance().isWaveOpen)
    ...
    private class RefreshProgressRunnable implements Runnable {
        public void run() {
            synchronized (Wave.this) {
                ...
                long gap = 70 - (System.currentTimeMillis() - start);
