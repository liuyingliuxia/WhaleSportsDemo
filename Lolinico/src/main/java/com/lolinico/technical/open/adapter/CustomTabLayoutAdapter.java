...
import com.lolinico.technical.open.widget.CustomViewPager;

/**
 * admin: Rico on 2018/11/23 0023
 */

public abstract class CustomTabLayoutAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CustomTabLayoutAdapter(Context context, CustomViewPager pager, boolean isWhale) {
        isWhaleTV = true;
        mContext = context;
    ...
    public abstract void onBindGroupHolder(CustomTabLayoutAdapter customTabAdapter, RecyclerView.ViewHolder holder, int position, int viewType);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        holder.itemView.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View view, boolean b) {
                ...
                if (customViewPager != null)
                    if (isBindGroupFragment(position) && b && customViewPager.getCurrentItem() != position) {
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case MSG_TAG:
                    if (customViewPager != null)
                        customViewPager.setCurrentItem(mFocusPosition);
                    break;
            }
        }
    };
